const DATE_BASE = [
  `- Cámara de seguridad para el hogar, precio 39 USD`,
  `- Sistema de alarma para casa, precio 29 USD`,
  `- Cámara de vigilancia externa, precio 29 USD`,
].join("\n");
...
- ID: CAMARA_HOGAR: Cámara de seguridad para el hogar. Precio: 39 USD.
- ID: ALARMA_CASA: Sistema de alarma para casa. Precio: 29 USD.
- ID: CAMARA_VIGILANCIA: Cámara de vigilancia externa. Precio: 29 USD.
...
- Tu objetivo principal es persuadir al cliente para que realice una compra escribiendo "transferencia" o "oca" o "master" o "visa". Destaca la oferta por tiempo limitado y los beneficios de los cursos.
